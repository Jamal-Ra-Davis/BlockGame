...
public class Attractor extends ForceObject {
	...
	public Attractor(Vector2d pos_, double mag_) {
		super(pos_);
		mag = mag_;
		color = Color.blue;
//		MAX_FORCE_MAG = 10;
	...
	public Attractor(double X, double Y, double mag_) {
		super(X,Y);
		mag = mag_;
		color = Color.blue;
//		MAX_FORCE_MAG = 10;
	...
	public void applyForce(BallModel ball) {
		...
		Vector2d force = Vector2d.makeVector(ball.getCenterPos(), getCenterPos());
